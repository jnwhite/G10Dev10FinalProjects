...
function submitData() {
	if (document.getElementById("confirm-validation").style.display == "block") {
	return true;} else {validateItems();}
	return false;
}
...
/*
	if (okayMessage === 0) {
		alert("Thank you for your information! Hit Send Request, and we will get back to you soon.");
		document.getElementById("confirm-validation").innerHTML = "Okay";
		return false;
	} else{return false;}
*/
	if (okayMessage === 0) {
